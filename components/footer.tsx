    ...
    <footer id="contact" className="bg-foreground text-background">
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold text-lg">Bánh Mì Hieudeptrai</h3>
          ...
          <div id="about" className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm text-background/70">
                ...
                <span>Ở đâu còn lâu mới nói</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-background/70">
                <Phone className="w-4 h-4 text-primary" />
                <span>079 913 2435</span>
              </div>
              {/* <div className="flex items-center gap-3 text-sm text-background/70">
        ...
        {/* <div className="border-t border-background/20 mt-8 pt-8 text-center text-sm text-background/50">
          <p>&copy; 2026 Bánh Mì Hieudeptrai. Đã đăng ký bản quyền.</p>
        </div> */}
      </div>
    </footer>
  )
